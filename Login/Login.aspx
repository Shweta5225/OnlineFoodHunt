<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OnlineFoodHunt.login" %>
                            ...
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form runat="server">
                                    ...
                                    <div class="custom-control custom-checkbox mb-3">
                                       <%-- <asp:CheckBox ID="CheckBox1" class="custom-control-input" id="customCheck1" runat="server" />--%>
                                        <%--<input type="checkbox" class="custom-control-input" id="customCheck1" />--%>
                                        <%--<label class="custom-control-label" for="customCheck1"> --%>
                                            <a class="font-weight-bold" href="../Forgot Password/ForgotPassword.aspx">Forgot password</a></label>

                                      

                                    </div>
                                    <a href="index.html" class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Log in</a>
                                    <div class="text-center pt-3">
                                        Don’t have an account? <a class="font-weight-bold" href="../Sign Up/SignUp.aspx">Sign Up</a>
                                ...
                                <div class="row">
                                    <div class="col pr-2">
                                        ...
                                        <a href="https://accounts.google.com/signin" class="btn pl-1 pr-1 btn-lg btn-google font-weight-normal text-white btn-block text-uppercase" type="submit"><i class="fab fa-google mr-2"></i>Google </a>
                                    </div>
                                    <div class="col pl-2">
                                        ...
                                        <a href="https://www.facebook.com/login/" class="btn pl-1 pr-1 btn-lg btn-facebook font-weight-normal text-white btn-block text-uppercase" type="submit"><i class="fab fa-facebook-f mr-2"></i>Facebook </a>
                                    </div>
                                </div>
                            </div>
                        </div>
